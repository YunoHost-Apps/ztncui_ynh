...
[![Nivel de integración](https://apps.yunohost.org/badge/integration/ztncui)](https://ci-apps.yunohost.org/ci/apps/ztncui/)
![Estado funcional](https://apps.yunohost.org/badge/state/ztncui)
![Estado En Mantención](https://apps.yunohost.org/badge/maintained/ztncui)
...
Por favor enviar sus correcciones a la [rama `testing`](https://github.com/YunoHost-Apps/ztncui_ynh/tree/testing).
