...
[![Integration level](https://apps.yunohost.org/badge/integration/ztncui)](https://ci-apps.yunohost.org/ci/apps/ztncui/)
![Working status](https://apps.yunohost.org/badge/state/ztncui)
![Maintenance status](https://apps.yunohost.org/badge/maintained/ztncui)
